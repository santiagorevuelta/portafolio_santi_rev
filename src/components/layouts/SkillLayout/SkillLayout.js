        ...
        <section className="skills section" id="skills">
                ...
                <div className="skills__container container grid">
                    <div className="skills__banner">
                        <div className="skills__banner-content">
                            <i className='bx bxl-react' title="React"></i>
                            <i className='bx bxl-nodejs' title="Node.js"></i>
                            <i className='bx bxl-postgresql' title="PostgreSQL"></i>
                            <i className='bx bxl-docker' title="Docker"></i>
                            <i className='bx bxl-java' title="Java"></i>
                            <i className='bx bxl-redux' title="Redux"></i>
                            <i className='bx bxl-tailwind-css' title="Tailwind"></i>
                            <i className='bx bxl-firebase' title="Firebase"></i>
                    ...
                    <div className="skills__content">
                        <h3 className="skills__title">Gestión y Despliegue</h3>
                        ...
                        <div className="skills__box">
                            ...
                            <div className="skills__group">
                                ...
                                <div className="skills__data">
                                    <i className='bx bx-badge-check' ></i>
                                    <div>
                                        <h3 className="skills__name">Metodologías Ágiles</h3>
                                        <span className="skills__level">Intermedio</span>
                                    </div>
                                </div>
                            </div>
